...
ADMINS = (
    ('Rafael Carlos Soriano Mármol', 'i02somar@uco.es'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'universidad.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'e9k%q!7l^h^yu+gza%!o+x(o(3)(6g_h4y4ez*mlezkv8m&amp;8ln'
